...
import com.bjy.lotuas.common.exception.CastException;
...
public class TypeUtil {
	...
	public static final Byte castToByte(Object value) {
		...
		throw new CastException("can not cast to byte, value : " + value);
	}
	...
	public static final Character castToChar(Object value) {
		...
		if (value instanceof String) {
			...
			if (strVal.length() != 1) {
				throw new CastException("can not cast to byte, value : "
						+ value);
			}
	...
	public static final Short castToShort(Object value) {
		...
		throw new CastException("can not cast to short, value : " + value);
	}
	...
	public static final Float castToFloat(Object value) {
		...
		throw new CastException("can not cast to float, value : " + value);
	}
	...
	public static final Double castToDouble(Object value) {
		...
		throw new CastException("can not cast to double, value : " + value);
	}
	...
	public static final Date castToDate(Object value) {
		...
		if (longValue <= 0) {
			throw new CastException("can not cast to Date, value : " + value);
		}
	...
	public static final Long castToLong(Object value) {
		...
		throw new CastException("can not cast to long, value : " + value);
	}
...
//	}
	...
	public static final <T> T cast(Object obj, Class<T> clazz) {
		...
		throw new CastException("can not cast to : " + clazz.getName());
	}
	...
	public static final <T> T castToEnum(Object obj, Class<T> clazz) {
		try {
			...
			throw new CastException("can not cast to : " + clazz.getName(), ex);
		}
		throw new CastException("can not cast to : " + clazz.getName());
	}
	...
	public static final <T> T cast(Object obj, Type type) {
		...
		throw new CastException("can not cast to : " + type);
	}
